...
<head>
  ...
  <style>
    ...
    * {margin: 0;padding: 0;box-sizing: border-box;}
    ...
    .feature {background: white;padding: 24px;border-radius: 12px;box-shadow: 0 4px 6px rgba(0,0,0,.1);}
  ...
  <div id="root">
    <div class="container">
      <header>
        ...
        <div class="buttons">
          <button class="primary" onclick="location.href='/download'">免费试用</button>
          <button class="secondary" onclick="location.href='/docs'">查看文档</button>
        </div>
      </header>
      ...
      <div class="pricing">
        ...
        <div class="plans">
          <div class="plan">
            ...
            <button class="primary" onclick="location.href='/download'">立即下载</button>
          </div>
          <div class="plan">
            <h3>专业版</h3>
            ...
            <button class="primary" onclick="location.href='/pricing'">立即购买</button>
          </div>
          <div class="plan">
            <h3>企业版</h3>
            ...
            <button class="primary" onclick="location.href='/contact'">联系我们</button>
          </div>
        </div>
      </div>
      ...
      <div class="demo">
        <h2>快速上手</h2>
        <div class="buttons">
          <button class="secondary" onclick="showDemo('mcp')">MCP协议验证</button>
